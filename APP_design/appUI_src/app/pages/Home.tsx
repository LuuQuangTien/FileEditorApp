...
export function Home() {
  ...
  const recentFiles = [
    { id: "1", name: "Q4 Report.pdf", type: "PDF", color: "bg-red-100 text-red-600" },
    { id: "2", name: "Budget.xlsx", type: "Excel", color: "bg-green-100 text-green-600" },
    { id: "3", name: "Proposal.docx", type: "Word", color: "bg-blue-100 text-blue-600" },
  ];
